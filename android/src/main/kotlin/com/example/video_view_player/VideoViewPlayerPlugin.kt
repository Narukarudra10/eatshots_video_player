package com.example.video_view_player
...
class VideoViewPlayerPlugin: FlutterPlugin, MethodCallHandler, ActivityAware, Application.ActivityLifecycleCallbacks {
  private lateinit var channel : MethodChannel
  private lateinit var context: Context
  private lateinit var textureRegistry: TextureRegistry
  private lateinit var binaryMessenger: BinaryMessenger
  private val players = HashMap<Long, VideoViewPlayer>()
  ...
  override fun onAttachedToEngine(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "video_view_player")
    channel.setMethodCallHandler(this)
    context = flutterPluginBinding.applicationContext
    textureRegistry = flutterPluginBinding.textureRegistry
    binaryMessenger = flutterPluginBinding.binaryMessenger

    networkEventChannel = EventChannel(flutterPluginBinding.binaryMessenger, "video_view_player/network_events")
  ...
  private fun startNetworkMonitoring() {
    ...
    try {
      ...
      android.util.Log.e("VideoViewPlayer", "Failed to register network callback: ${e.message}")
    }
  }
    ...
    when (call.method) {
      ...
      "initialize" -> {
        ...
        try {
          ...
          val player = VideoViewPlayer(context, url, textureEntry, binaryMessenger)
...
class VideoViewPlayer(
    ...
    init {
        val textureId = textureEntry.id()
        eventChannel = EventChannel(binaryMessenger, "video_view_player/videoEvents_$textureId")
        ...
        android.util.Log.d("VideoViewPlayer", "VideoViewPlayer init: URL=$url, defaultDataSourceFactory=$defaultDataSourceFactory")
        ...
        android.util.Log.d("VideoViewPlayer", "VideoViewPlayer init: URL=$url, NetworkType=$networkType, Buffers=[min:$minBufferMs, max:$maxBufferMs, play:$bufferForPlaybackMs, rebuffer:$bufferForPlaybackAfterRebufferMs]")
                    ...
                    override fun onVideoSizeChanged(videoSize: VideoSize) {
                        ...
                        if (videoWidth > 0 && videoHeight > 0) {
                            try {
                                ...
                                android.util.Log.e("VideoViewPlayer", "Failed to set default buffer size", e)
                            }
                        }
